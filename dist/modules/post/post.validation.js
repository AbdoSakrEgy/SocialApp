...
exports.createPostSchema = zod_1.default
    ...
    avilableFor: zod_1.default
        .enum(Object.values(post_model_js_1.PostAvilableForEnum)) // Since your enum uses string values
        .default(post_model_js_1.PostAvilableForEnum.PUBLIC)
        .optional(),
...
exports.updatePostSchema = zod_1.default.object({
    ...
    avilableFor: zod_1.default
        .enum(Object.values(post_model_js_1.PostAvilableForEnum))
        .optional(),
